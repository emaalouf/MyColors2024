...
// bind services with interfaces
$app->bind(CustomerBalanceInterface::class, CustomerBalanceService::class);

$app->bind(CatalogServiceInterface::class, CatalogService::class);

$app->bind(ContentServiceInterface::class, ContentService::class);

$app->bind(CustomerServiceInterface::class, CustomerService::class);

$app->bind(SalesServiceInterface::class, SalesService::class);
// end of binding
return $app;
